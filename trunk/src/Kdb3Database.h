...
private:
    ...
    bool cli; ///< disable GUI calls. Must be set in constructor, since no GUI information is analyzed while opening db; connot be unset since UI info required without the flag will be missing be the moment the flag will be unset.
};
